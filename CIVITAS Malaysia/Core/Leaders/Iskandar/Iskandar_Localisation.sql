...
-----------------------------------------------	
	...
	("LOC_LEADER_CVS_ISKANDAR_NAME",  "Iskandar"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("LOC_TRAIT_LEADER_CVS_ISKANDAR_UA_NAME",  "Genealogy of Kings"	),
	("LOC_TRAIT_LEADER_CVS_ISKANDAR_UA_DESCRIPTION",
	"Sending an [ICON_Envoy] Envoy to a City-State grants [ICON_GreatPerson] Great Person points of its respective type. Receive +1 [ICON_Citizen] Population when a City spawns a [ICON_GreatPerson] Great Person, and expending it within a City expands its borders by 2 tiles."	),

-----------------------------------------------
-- Agenda
-----------------------------------------------	

	("LOC_AGENDA_CVS_ISKANDAR_NAME",	"Bersatu Teguh"	),
	("LOC_AGENDA_CVS_ISKANDAR_DESCRIPTION",	"Likes Civilizations with high population and many Great People. Dislikes those those with a weak economy."	),
	("LOC_DIPLO_KUDO_LEADER_CVS_ISKANDAR_REASON_ANY",	"(You have high population cities and many great people.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ISKANDAR_HAPPY",	"Iskandar admires a populace filled with great people"	),
	("LOC_DIPLO_WARNING_LEADER_CVS_ISKANDAR_REASON_ANY",	"(You have a weak economy.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ISKANDAR_UNHAPPY",	"Iskandar is disappointed in your weak economy"	),
		
-----------------------------------------------
-- DOM
-----------------------------------------------	

	("LOC_LOADING_INFO_LEADER_CVS_ISKANDAR",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_ISKANDAR_ANY",
	"Excellent!"	),
	
	-- AI invitation to exchange Capital Information (ANY)
	("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	-- (HAPPY)
	("LOC_DIPLO_GREETING_LEADER_CVS_ISKANDAR_HAPPY",
	"It's good to see you again, friend. What can I do for you?"	),

	-- (UNHAPPY)
	("LOC_DIPLO_GREETING_LEADER_CVS_ISKANDAR_UNHAPPY",
	"I'm listening."	),
...
-----------------------------------------------	
	...
	-- AI Accepts (ANY)
	("LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"I gladly accept. Your delegates are welcome to stay and enjoy their time in Malacca."	),
	
	-- AI Rejects (ANY)
	("LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"I'm sorry, but I cannot allow that at this time."	),
	
	-- AI Requests (ANY)
	("LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"Of course, please enjoy your time here."	),
	
	-- AI rejects from human (ANY)	
	("LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"I'm sorry, but I cannot allow that at this time."	),
	
	-- AI requests from human (ANY)	
	("LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	-- AI accepts from human (ANY)
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"The pleasure would be all mine."	),
	
	-- AI rejects from human (ANY)	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"I see no friend in you."	),
	
	-- AI Requests friendship from human (ANY)	
	("LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
	"You are a gifted ruler who knows the value of good relations. I formally extend to you my hand in friendship."	),
	
	-- Human accepts AI requests, AI responds (ANY)	
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
	"What a fine day! May this become the start of something wonderful."	),
	
	-- Human rejects AI requests, AI responds (ANY)	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
	"That is a pity."	),
...
-----------------------------------------------	
	...
	("LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_ISKANDAR_HAPPY",
	"I say this with good will; please remove your troops from my borders or it will be seen as an act of aggression."	),

	-- AI warns player for border troops (UNHAPPY)
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_ISKANDAR_UNHAPPY",
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_ISKANDAR_HAPPY",
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_ISKANDAR_UNHAPPY",
	"Very well. This will not be forgotten."	),
	
	-- AI rejects player's warning for border troops warning (ANY) ~ DECLARES WAR
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_CVS_ISKANDAR_HAPPY",
	...
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_CVS_ISKANDAR_UNHAPPY",
	"I have noticed you that you settled in Malaccan territory. Wars have been started over less. Let this be a warning."	),
	
	-- Positive AI response to human request (HAPPY)
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_ISKANDAR_HAPPY",
	"My sincere apologies, we didn't mean to intrude. We shall look elsewhere next time."	),
	
	-- Positive AI response to human request (UNHAPPY)
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_ISKANDAR_UNHAPPY",
	...
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_ISKANDAR_HAPPY",
	"Don't be silly, friend. There is enough room for the both of us."	),
	
	-- Negative AI response to human request (UNHAPPY)
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_ISKANDAR_UNHAPPY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_ISKANDAR_HAPPY",
	"Excellent!"	),
	
	-- AI Accepts Deal (Unhappy)
	("LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_ISKANDAR_UNHAPPY",
	"This shall suffice, for now."	),

	-- AI Rejects Deal (HAPPY)
	("LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_ISKANDAR_HAPPY",
	"I'd appreciate a better deal than this."	),
	
	-- AI Rejects Deal (Unhappy)
	("LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_ISKANDAR_UNHAPPY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"Words often fall on deaf ears when they are spoken by those who deserve no respect. Who are you again?"	),
	
	-- From AI
	("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"I applaud your bravery, but your intelligence leaves much to be desired."	),
	
	-- AI Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_CVS_ISKANDAR_ANY",
	"I agree, a peace treaty seems to be in both our interests."	),
	
	-- AI refuses human
	("LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_CVS_ISKANDAR_ANY",
	"No, you will learn nothing should this war end now."	),
	
	-- AI requests from human
	("LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
...
-----------------------------------------------	
	...
	-- AI is Defeated
	("LOC_DIPLO_DEFEAT_FROM_AI_LEADER_CVS_ISKANDAR_ANY",
	"Today you may have glory, but tomorrow you will come sooner than you think."	),

	-- Human is Defeated (will see this in hotseat)
	("LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_CVS_ISKANDAR_ANY",
	"Today you may have glory, but tomorrow you will come sooner than you think."	),
...
--------------------------------------------------------------------
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ISKANDAR_CHAPTER_HISTORY_PARA_1",
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ISKANDAR_CHAPTER_HISTORY_PARA_2",
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ISKANDAR_CHAPTER_HISTORY_PARA_3",
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ISKANDAR_CHAPTER_HISTORY_PARA_4",
